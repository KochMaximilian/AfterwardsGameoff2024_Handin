...
public static class EventBusUtil {
    ...
    public static void RaiseEvent(IEvent eventData) {
        var busType = typeof(EventBus<>).MakeGenericType(eventData.GetType());
        var raiseMethod = busType.GetMethod("Raise", BindingFlags.Static | BindingFlags.Public);
        raiseMethod?.Invoke(null, new object[]{eventData});
    }
}